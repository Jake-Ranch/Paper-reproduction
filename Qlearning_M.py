...
# if 1:
    ...
    with torch.no_grad():
        ...
        save_agent(test_resultlist, str(M) + 'Qtest_resultlist.pkl')
        save_agent(losslist, str(M) + 'Qlosslist.pkl')
        save_agent(actionbar, str(M) + 'Qactionbar.pkl')
        save_agent(Energylist,str(M)+'QEnergylist.pkl')
        save_agent(Utilitylist,str(M)+'QUtilitylist.pkl')
        save_agent(Latencylist,str(M)+'QLatencylist.pkl')
        save_agent(Privacylist,str(M)+'QPrivacylist.pkl')
        ...
        if 0:
            ...
            save_agent(Energylist, str(L) + 'QEnergylist.pkl')
            save_agent(Utilitylist, str(L) + 'QUtilitylist.pkl')
            save_agent(Latencylist, str(L) + 'QLatencylist.pkl')
            save_agent(Privacylist, str(L) + 'QPrivacylist.pkl')
            plt.plot(actionbar)
            plt.show()
