...
class myenv():
    ...
    def step(self,state,action,show=False):
        ...
        reward=psi*Pmt-Cmt
        if reward<-100:
            print(self.time,action,'Bmt',self.Bmt,'Qmt',self.Qmt/1000,'hmt',self.hmt,'Tmt',Tmt*miu,'Amt',Amt/1000,'Pmt',psi*Pmt,'Cmt',Cmt,'Emt',Emt*v,'reward',reward,'Pmut',beta1*Pmut,'Pmlt',beta2*Pmlt)
